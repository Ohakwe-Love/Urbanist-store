...
Route::prefix('admin')
    ...
    ->group(function () {
        ...
        Route::get('support/{contactMessage}', [SupportController::class, 'show'])->name('support.show');
        Route::post('support/{contactMessage}/reply', [SupportController::class, 'reply'])->name('support.reply');
        Route::get('newsletters', [NewsletterSubscriberController::class, 'index'])->name('newsletters.index');
