<x-layout>
    ...
    @php
        ...
        $aboutBlock = ($contentBlocks['about_page_content']['is_active'] ?? true) ? ($contentBlocks['about_page_content'] ?? $defaultBlocks['about_page_content']) : $defaultBlocks['about_page_content'];
    @endphp
        ...
        <div class="container">
            ...
            <div class="about-company-content">
                <div class="about-company-text">
                    ...
                    @foreach (preg_split("/\r\n|\n|\r/", $aboutBlock['content']) as $paragraph)
                        @if (trim($paragraph) !== '')
                            <p>{{ trim($paragraph) }}</p>
                        @endif
                    @endforeach
    ...
    <section class="section services" id="services">
        <div class="container">
            <div class="services-intro">
                <h3>{{ $aboutBlock['meta']['services_heading'] ?? 'Ready to Upgrade Your Living Space?' }}</h3>
                <p>{{ $aboutBlock['meta']['services_content'] ?? 'Whether you are furnishing a new home, redesigning a space, or simply looking for that perfect accent piece, Urbanist offers comprehensive services to meet your needs.' }}</p>
            </div>
